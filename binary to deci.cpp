...
{
    unsigned long binary_num, decimal = 0,decimale;
    cout <<"\n\tEnter a binary number to get : ";
    cout<< "Equivalent Decimal : ";
    cin >> binary_num;
    decimal=ConvertBinary2Decimal(binary_num,decimale);
    cout <<"\n\tDecimal Value Of  " <<binary_num << " is = " << decimal << endl;
    return 0;

}

long ConvertBinary2Decimal(unsigned long bin_num,unsigned long decimal = 0)
{
